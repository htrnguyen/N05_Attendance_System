...
namespace GUI.Forms.StudentForms
{
    public partial class StudentCoursesForm : Form
    {
        ...
        public StudentCoursesForm(MainForm.MainDashboardForm mainDashboardForm, int userID, int termID)
        {
            InitializeComponent();
        ...
        {
            var courses = _studentService.GetCourses(_userID, _termID);
        ...
        private void CoursePanel_Click(object sender, EventArgs e)
        {
            ...
            StudentWeeksForm studentWeeks = new StudentWeeksForm(_mainDashboardForm, _userID, course);
            _mainDashboardForm.ShowForm(studentWeeks);
        }
